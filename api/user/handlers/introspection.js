...
module.exports = [
    { name: 'user.register', params: [{name: 'name', type: 'string'}, {name: 'email', type: 'string'}, {name: 'phone', type: 'string'}], description: 'Register new user', ai: true, public: true },
    ...
    { name: 'user.profile', params: [{name: 'uid', type: 'string'}], description: 'Get user profile', ai: true },
    { name: 'user.list', params: [], description: 'List users (Admin only)', ai: true },
