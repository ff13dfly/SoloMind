...
app.post('/jsonrpc', async (req, res) => {
    ...
    try {
        ...
        if (method === 'gateway.ping') {
            result = await Methods.gateway.ping();
        } else if (method === 'gateway.echo') {
            result = await Methods.gateway.echo(params);
        }
        // Email
        else if (method === 'gateway.email.send') {
            result = await Methods.email.send(params);
        }
        // SMS
        else if (method === 'gateway.sms.send') {
            result = await Methods.sms.send(params);
        }
